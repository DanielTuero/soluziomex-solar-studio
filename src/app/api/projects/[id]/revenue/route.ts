  ...
  try {
    ...
    const result = await query(
      `INSERT INTO revenue_models
       (project_id, monthly_customer_fee, contract_years, installer_share_pct, maintenance_reserve_pct, platform_share_pct, annual_fee_escalation_pct, discount_rate_pct)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8)
       ON CONFLICT (project_id) DO UPDATE SET monthly_customer_fee=EXCLUDED.monthly_customer_fee,
       ...
       RETURNING *`,
      [id, body.monthly_customer_fee, body.contract_years, body.installer_share_pct, body.maintenance_reserve_pct,
